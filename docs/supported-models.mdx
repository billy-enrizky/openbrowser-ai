...
## Browser-Use LLM [example](https://github.com/billy-enrizky/openbrowser-ai/blob/main/examples/models/openbrowser_llm.py)

`ChatBrowserUse()` is an optimized model from [browser-use.com](https://browser-use.com) designed specifically for browser automation tasks.
