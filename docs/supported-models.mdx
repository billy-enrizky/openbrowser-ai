...
### OpenBrowser [example](https://github.com/billy-enrizky/openbrowser-ai/blob/main/examples/models/openbrowser_llm.py)
...
**Examples available:**
- [DeepSeek](https://github.com/billy-enrizky/openbrowser-ai/blob/main/examples/models/deepseek-chat.py)
- [Novita](https://github.com/billy-enrizky/openbrowser-ai/blob/main/examples/models/novita.py)
- [OpenRouter](https://github.com/billy-enrizky/openbrowser-ai/blob/main/examples/models/openrouter.py)
