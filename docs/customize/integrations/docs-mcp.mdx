...
```bash
claude mcp add --transport http openbrowser https://openbrowser.github.io/docs/mcp
```
</Tab>
<Tab title="Cursor">
...
```json
{
  "mcpServers": {
    "openbrowser-docs": {
      "url": "https://openbrowser.github.io/docs/mcp"
    }
  }
}
```
...
```json
{
  "mcpServers": {
    "openbrowser-docs": {
      "serverUrl": "https://openbrowser.github.io/docs/mcp"
    }
  }
}
```
...
- Serves openbrowser documentation over HTTP
