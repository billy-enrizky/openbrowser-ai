...
# 1. Clone repo 
git clone https://github.com/billy-enrizky/vibetest-use.git
cd vibetest-use
...
Full implementation: [https://github.com/billy-enrizky/vibetest-use](https://github.com/billy-enrizky/vibetest-use)
