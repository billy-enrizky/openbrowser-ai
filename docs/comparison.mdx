...
Benchmark date: 2026-02-19 | OpenBrowser MCP v0.1.21 (CodeAgent, 1 tool) | Playwright MCP (latest) | Chrome DevTools MCP (latest)
...
| Metric | Playwright MCP | Chrome DevTools MCP | OpenBrowser MCP |
|--------|---------------:|--------------------:|----------------:|
| **Total tool calls** | 10 | 21 | 20 |
| **Avg tool calls/task** | 1.7 | 3.5 | 3.3 |
| **Total duration** | 85.3s | 135.5s | 110.5s |
...
- OpenBrowser MCP v0.1.21 tested via `uvx openbrowser-ai[mcp]==0.1.21 --mcp`
- All tests run on macOS, M-series Apple Silicon
- Benchmark script: `benchmarks/e2e_llm_benchmark.py`
- Results: `benchmarks/e2e_llm_results.json`
