...
- Refer to the [OpenBrowser documentation](https://openbrowser.mintlify.app) for instruction best practices

## Resources

- [n8n Community Nodes Documentation](https://docs.n8n.io/integrations/community-nodes/)
- [OpenBrowser Documentation](https://openbrowser.mintlify.app)
