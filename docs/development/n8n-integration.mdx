...
To use the OpenBrowser node in n8n, you need to configure API credentials:
...
- Refer to the [OpenBrowser documentation](https://openbrowser.github.io/docs) for instruction best practices

## Resources

- [n8n Community Nodes Documentation](https://docs.n8n.io/integrations/community-nodes/)
- [OpenBrowser Documentation](https://openbrowser.github.io/docs)
- [Browser Use Cloud](https://cloud.browser-use.com)
- [n8n-nodes-openbrowser GitHub Repository](https://github.com/draphonix/n8n-nodes-openbrowser) 
