...
OpenBrowser can sync your agent runs to the cloud for easy viewing and sharing. Authentication is required to protect your data.
...
rm ~/.config/openbrowser/cloud_auth.json
openbrowser auth
```
