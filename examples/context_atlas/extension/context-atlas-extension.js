(() => {
  ...
  // src/shared/state.js
  var SUPPORTED_PROVIDERS = Object.freeze(["jev", "laya"]);
  ...
  function invalidateProviderRequest(requestRef, clearResult = () => {
  }) {
  ...
  function findSourceMatch(result, passages, resultIndex = 0) {
    const candidates = Array.isArray(result?.matches) && result.matches.length ? result.matches : Array.isArray(result?.scores) ? result.scores : [];
  ...
  function validSourceMatches(result, passages) {
    const candidates = Array.isArray(result?.matches) && result.matches.length ? result.matches : Array.isArray(result?.scores) ? result.scores : [];
    return candidates.map((_, index) => findSourceMatch({ matches: candidates }, passages, index)).filter(Boolean);
  }
  function buildProvenanceThread(result, passages, query) {
  ...
  function createRuntimeAdapter({ sendMessage }) {
  ...
  function BusyProgress({ label = "Loading", value = 50, showValue = false }) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "context-atlas-loading-progress", role: "progressbar", "aria-label": label, "aria-valuemin": "0", "aria-valuemax": "100", "aria-valuenow": progress, style: { "--context-atlas-progress": progress / 100 } }),
      showValue ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "context-atlas-progress-value", children: [
        progress,
        "%"
      ] }) : null
    ] });
  ...
  function ContextAtlasSurface({
    ...
    const [activePassages, setActivePassages] = (0, import_react3.useState)(sourcePassages);
    ...
    const [ambiguousSelection, setAmbiguousSelection] = (0, import_react3.useState)(null);
    const [traceOpen, setTraceOpen] = (0, import_react3.useState)(false);
    ...
    async function chooseProvider(nextProvider) {
      ...
      try {
        ...
        setStatus({
          kind: "idle",
          message: next === "laya" ? "Local search stays in this browser. The model prepares on first use." : "Cloud search is ready when you save an access key.",
          retryable: false
        });
      } catch (error) {
    ...
    async function searchSource(event, queryOverride = null) {
      ...
      try {
        ...
        setStatus({
          kind: "success",
          message: ambiguous ? "We found a few close matches. Choose one." : `${normalizedResult.matches.length} source-backed result${normalizedResult.matches.length === 1 ? "" : "s"}.`,
          retryable: false
        });
      } catch (error) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: `context-atlas context-atlas-${surface}`, "data-testid": "context-atlas-surface", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", { className: "context-atlas-header", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
          surface !== "extension" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "context-atlas-eyebrow", children: "CONTEXT ATLAS" }) : null,
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", { children: surface === "extension" ? "Find what matters" : "Find what matters in your source." }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "context-atlas-lede", children: "Ask in plain language. Find the passage that answers it." })
        ] }),
        onClose ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { className: "context-atlas-icon-button", type: "button", onClick: onClose, "aria-label": "Close", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(X, { size: 18 }) }) : null
      ] }),
      providerEnabled ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { className: "context-atlas-card context-atlas-provider-card", "aria-label": "Search provider", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { id: "context-atlas-provider-panel-laya", className: "context-atlas-provider-status", role: "tabpanel", "aria-labelledby": "context-atlas-provider-tab-laya", hidden: provider !== "laya", children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "context-atlas-provider-status-title", children: "Private browser search" }),
      ...
      activeProvider === "jev" && typeof adapter?.getKeyStatus === "function" ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { className: "context-atlas-card context-atlas-key-card", role: providerEnabled ? "tabpanel" : void 0, id: providerEnabled ? "context-atlas-provider-panel-jev" : void 0, "aria-labelledby": providerEnabled ? "context-atlas-provider-tab-jev" : "context-atlas-key-heading", hidden: providerEnabled && provider !== "jev", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "context-atlas-section-heading", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", { id: "context-atlas-key-heading", children: "Cloud access key" })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: `context-atlas-badge ${keyConfigured ? "is-success" : keyConfigured === false ? "is-muted" : "is-warn"}`, children: keyConfigured ? "Saved locally" : keyConfigured === false ? "Not set up" : "Checking\u2026" })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "context-atlas-card-copy", id: "context-atlas-key-help", children: "Your key stays local." }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", { className: "context-atlas-key-form", onSubmit: saveKey, children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { htmlFor: "context-atlas-api-key", children: "Cloud access key" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "context-atlas-input-row", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "context-atlas-input-with-icon", children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(KeyRound, { size: 16, "aria-hidden": "true" }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", { id: "context-atlas-api-key", type: "password", value: apiKey, onChange: (event) => setApiKey(event.target.value), autoComplete: "off", spellCheck: "false", placeholder: "Paste your access key", "aria-describedby": "context-atlas-key-help" })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { className: "context-atlas-primary-button", type: "submit", disabled: keyBusy, children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "context-atlas-button-content", children: [
              keyAction === "save" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(BusyProgress, { label: "Saving access key" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Check, { size: 16, "aria-hidden": "true" }),
              "Save key"
            ] }) })
          ] })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "context-atlas-key-footer", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "context-atlas-field-note", role: "status", "aria-live": "polite", children: keyConfigured ? "Ready to search with Cloud." : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
            "Get your Cloud key at ",
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", { className: "context-atlas-inline-link", href: "https://console.typesafe.ai/login", target: "_blank", rel: "noopener noreferrer", children: "console.typesafe.ai" }),
            "."
          ] }) }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { className: "context-atlas-quiet-button", type: "button", onClick: clearKey, disabled: keyBusy || !keyConfigured, children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "context-atlas-button-content", children: [
            keyAction === "clear" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(BusyProgress, { label: "Removing saved key" }) : null,
            "Clear saved key"
          ] }) })
        ] })
      ] }) : null,
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { className: "context-atlas-card context-atlas-search-card", "aria-labelledby": "context-atlas-search-heading", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "context-atlas-section-heading", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "context-atlas-eyebrow", children: "SEARCH" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", { id: "context-atlas-search-heading", children: "Ask a question" })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "context-atlas-source-count", children: [
            passages.length,
            " ",
            passages.length === 1 ? "section" : "sections"
          ] })
        ] }),
        sourceEditor,
        sourceStatus ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: `context-atlas-source-status is-${sourceStatus.kind || "idle"}`, role: "status", "aria-live": "polite", "aria-busy": sourceStatus.kind === "loading", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "context-atlas-status-message", children: [
            sourceStatus.kind === "loading" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(BusyProgress, { label: sourceStatus.message }) : null,
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: sourceStatus.message })
          ] }),
          onRefreshSource ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", { className: "context-atlas-quiet-button", type: "button", onClick: () => void onRefreshSource(), disabled: sourceStatus.kind === "loading", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(RefreshCw, { size: 14, "aria-hidden": "true" }),
            "Refresh from current page"
          ] }) : null
        ] }) : null,
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", { className: "context-atlas-query-form", onSubmit: searchSource, children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { htmlFor: "context-atlas-query", children: "What do you want to find?" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "context-atlas-input-row", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", { id: "context-atlas-query", value: query, maxLength: 400, onChange: (event) => setQuery(event.target.value), placeholder: "Ask about this page", autoComplete: "off" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { className: "context-atlas-primary-button", type: "submit", disabled: status.kind === "loading", children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "context-atlas-button-content", children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Route, { size: 16, "aria-hidden": "true" }),
              "Find it"
            ] }) })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "context-atlas-query-footer", children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "context-atlas-field-note", children: [
            query.length,
            " / 400"
          ] }) })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: `context-atlas-status is-${status.kind}`, role: "status", "aria-live": "polite", "aria-busy": status.kind === "loading", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "context-atlas-status-message", children: [
            showSearchProgress ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "context-atlas-status-progress", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(BusyProgress, { label: status.message, value: status.kind === "success" ? 100 : searchProgress, showValue: true }) }) : null,
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "context-atlas-status-copy", children: [
              status.kind === "loading" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("progress", { className: "context-atlas-status-spinner", "aria-hidden": "true" }) : null,
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: status.message })
            ] })
          ] }),
          status.retryable ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", { className: "context-atlas-retry-button", type: "button", onClick: retry, children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(RefreshCw, { size: 14, "aria-hidden": "true" }),
            "Retry"
          ] }) : null
        ] })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "context-atlas-results-layout", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", { className: "context-atlas-card context-atlas-focused-card", "aria-live": "polite", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "context-atlas-section-heading", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "context-atlas-eyebrow", children: "RESULT" }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", { children: focused ? "Best match" : result?.ambiguous ? "Choose a match" : "Your result will appear here" })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "context-atlas-field-note", children: focused ? `${confidence(focused.probability)}% relevant` : "" })
          ] }),
          result?.ambiguous && ambiguousSelection === null ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "context-atlas-ambiguity", role: "group", "aria-label": "Close source matches", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "context-atlas-empty", children: "We found a few close matches. Choose one to see it on the page." }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ol", { className: "context-atlas-ambiguity-list", children: matches.slice(0, 5).map((match, index) => {
              const candidate = findSourceMatch({ matches: [match] }, passages);
              if (!candidate) return null;
              return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", { className: "context-atlas-ambiguity-button", type: "button", onClick: () => selectResult(index), children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: candidate.sentence.text }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "context-atlas-field-note", children: [
                  confidence(match.probability),
                  "%"
                ] })
              ] }) }, `${match.passage_id}:${match.sentence_index}`);
            }) })
          ] }) : focusedSource ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("blockquote", { className: "context-atlas-quote", children: focusedSource.sentence.text }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "context-atlas-empty", children: "Ask a question to get started." }),
          focusedSource ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { className: "context-atlas-source-byline", children: [
            "From ",
            focusedSource.passage.title || source?.title || "this source"
          ] }) : null,
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "context-atlas-result-actions", children: [
            focused ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", { className: "context-atlas-trace-button", type: "button", "aria-expanded": traceOpen, onClick: () => setTraceOpen((value) => !value), children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Route, { size: 15, "aria-hidden": "true" }),
              traceOpen ? "Hide details" : "Show why"
            ] }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {}),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "context-atlas-field-note", children: matches.length ? `${current + 1} of ${matches.length}` : "" })
          ] }),
          traceOpen && provenance.length ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ol", { className: "context-atlas-provenance", "aria-label": "How this result was found", children: provenance.map((node) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", { children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "context-atlas-provenance-label", children: node.label }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: node.text }),
            typeof node.probability === "number" ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "context-atlas-provenance-score", children: [
              confidence(node.probability),
              "%"
            ] }) : null
          ] }, node.kind)) }) : null,
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "context-atlas-navigation", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", { className: "context-atlas-quiet-button", type: "button", onClick: () => selectResult(current - 1), disabled: !matches.length || current === 0, children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronLeft, { size: 15, "aria-hidden": "true" }),
              "Previous"
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", { className: "context-atlas-quiet-button", type: "button", onClick: () => selectResult(current + 1), disabled: !matches.length || current === matches.length - 1, children: [
              "Next",
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronRight, { size: 15, "aria-hidden": "true" })
            ] })
          ] })
        ] }),
        surface !== "extension" ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", { className: "context-atlas-card context-atlas-source-card", "aria-labelledby": "context-atlas-source-heading", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "context-atlas-section-heading", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", { id: "context-atlas-source-heading", children: source?.title || "Current page" }) }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "context-atlas-source-rule" })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "context-atlas-source-text", children: passages.length ? passages.map((passage) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: renderPassage(passage, focused) }, passage.id)) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "context-atlas-empty", children: "Open the extension on a webpage, then refresh this page." }) })
        ] }) : null
      ] }),
  ...
  function renderPassage(passage, focused) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
      passage.text.slice(0, offset.start),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("mark", { className: "context-atlas-highlight", children: passage.text.slice(offset.start, offset.end) }),
      passage.text.slice(offset.end)
    ] });
  }

  // src/extension/range-utils.js
  function findTextNodeSegments(textNodes, start, end) {
  ...
  // src/extension/search-context.js
  ...
  var SOURCE_BOUNDARY_PASSAGES = 8;
  function planSourcePassages(query, passages) {
  ...
  var PANEL_ID = "context-atlas-extension-panel";
  var PAGE_HIGHLIGHT_NAME = "context-atlas-page-highlight";
  var PAGE_HIGHLIGHT_STYLE_ID = "context-atlas-page-highlight-style";
  ...
  function collectPageSource(query = "") {
    const rawPassages = [];
    const rawElements = /* @__PURE__ */ new Map();
    let section = "";
  ...
  function ExtensionApp({ adapter, initialSource, onSourceChange }) {
    ...
    (0, import_react4.useEffect)(() => onSourceChange((nextSource) => {
      sourceRef.current = nextSource;
      setSource(nextSource);
    }), [onSourceChange]);
    const prepareSearch = (0, import_react4.useCallback)((query) => {
      const nextSource = collectPageSource(query);
      sourceRef.current = nextSource;
      return nextSource;
    }, []);
    const surfaceAdapter = (0, import_react4.useMemo)(() => ({
      ...adapter,
