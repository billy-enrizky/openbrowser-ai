    ...
    <div className={`context-atlas context-atlas-${surface}`} data-testid="context-atlas-surface">
      ...
      {providerEnabled ? <section className="context-atlas-card context-atlas-provider-card" aria-label="Search provider">
        <div className="context-atlas-provider-tabs" role="tablist" aria-label="Search provider">
          <button id="context-atlas-provider-tab-laya" data-provider="laya" className="context-atlas-provider-tab" type="button" role="tab" aria-selected={provider === "laya"} aria-controls="context-atlas-provider-panel-laya" tabIndex={provider === "laya" ? 0 : -1} onClick={() => void chooseProvider("laya")} onKeyDown={handleProviderKeyDown} disabled={providerBusy}>Local</button>
          <button id="context-atlas-provider-tab-jev" data-provider="jev" className="context-atlas-provider-tab" type="button" role="tab" aria-selected={provider === "jev"} aria-controls="context-atlas-provider-panel-jev" tabIndex={provider === "jev" ? 0 : -1} onClick={() => void chooseProvider("jev")} onKeyDown={handleProviderKeyDown} disabled={providerBusy}>Cloud</button>
        </div>
