...
This example shows how to use the OpenBrowser API to extract specific
...
if __name__ == '__main__':
	...
	asyncio.run(search_url('https://browser-use.com/#pricing', 'Find pricing information for OpenBrowser'))
	...
	# asyncio.run(search_url("https://github.com/billy-enrizky/openbrowser-ai", "installation instructions", depth=2))
